...
testgroups = [
  ...
  TestGroup { group_title = "errors", group_tests = [
    ...
    TestShaderCompileError { name = "InterpreterErrorDynamicIterate", vert = "\\(n)()() -> let id x = (True, x) in (iterate id n [0,0,0,0], ())", frag = "\\()()() -> [0,0,0,0]", expect_error = \ e -> case e of InterpreterError _ (InterpreterErrorDynamicIterate) -> True; _ -> False },
