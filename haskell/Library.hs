...
library = [
  (Prefix, show OpScalarNeg, "Real -> Real", "scalar negate (as desugared from \"-\")", False, ["x"], undefined),
  (Prefix, show OpVectorNeg, "Real 'n -> Real 'n", "vector negate (component-wise) (as desugared from \"--\")", False, ["x"], undefined),
  (Prefix, show OpNot, "Bool -> Bool", "logical not", False, ["x"], undefined),
  ...
  (InfixL, show OpScalarAdd, "Real -> Real -> Real", "scalar add", False, ["x", "y"], undefined),
  (InfixL, show OpScalarSub, "Real -> Real -> Real", "scalar sub", False, ["x", "y"], undefined),
  (InfixL, show OpScalarMul, "Real -> Real -> Real", "scalar mul", False, ["x", "y"], undefined),
  (InfixL, show OpScalarDiv, "Real -> Real -> Real", "scalar div", False, ["x", "y"], undefined),
  ...
  (InfixN, show OpLessThan, "Real -> Real -> Bool", "less than", False, ["x", "y"], undefined),
  (InfixN, show OpLessThanEqual, "Real -> Real -> Bool", "less than or equal", False, ["x", "y"], undefined),
  (InfixN, show OpGreaterThan, "Real -> Real -> Bool", "greater than", False, ["x", "y"], undefined),
  (InfixN, show OpGreaterThanEqual, "Real -> Real -> Bool", "greater than or equal", False, ["x", "y"], undefined),
  (InfixN, show OpEqual, "'a -> 'a -> Bool", "equality", False, ["x", "y"], undefined),
  (InfixN, show OpNotEqual, "'a -> 'a -> Bool", "inequality", False, ["x", "y"], undefined),
  (InfixL, show OpAnd, "Bool -> Bool -> Bool", "logical and", False, ["x", "y"], undefined),
  (InfixL, show OpOr, "Bool -> Bool -> Bool", "logical or", False, ["x", "y"], undefined),
  ...
  (Prefix, "sin", "Real -> Real", "sine (radians)", False, ["a"], undefined),
  (Prefix, "cos", "Real -> Real", "cosine (radians)", False, ["a"], undefined),
  (Prefix, "tan", "Real -> Real", "tangent (radians)", False, ["a"], undefined),
  (Prefix, "asin", "Real -> Real", "arcsine (radians)", False, ["x"], undefined),
  (Prefix, "acos", "Real -> Real", "arccosine (radians)", False, ["x"], undefined),
  (Prefix, "atan", "Real -> Real -> Real", "arctangent (radians)", False, ["x", "y"], undefined),
  (Prefix, "pow", "Real -> Real -> Real", "power", False, ["x", "y"], undefined),
  (Prefix, "exp", "Real -> Real", "power (base e)", False, ["x"], undefined),
  (Prefix, "exp2", "Real -> Real", "power (base 2)", False, ["x"], undefined),
  (Prefix, "log", "Real -> Real", "logarithm (base e)", False, ["x"], undefined),
  (Prefix, "log2", "Real -> Real", "logarithm (base 2)", False, ["x"], undefined),
  (Prefix, "sqrt", "Real -> Real", "square root", False, ["x"], undefined),
  (Prefix, "rsqrt", "Real -> Real", "reciprocal square root", False, ["x"], undefined),
  (Prefix, "abs", "Real -> Real", "absolute value", False, ["x"], undefined),
  (Prefix, "floor", "Real -> Real", "round to negative infinity", False, ["x"], undefined),
  (Prefix, "ceiling", "Real -> Real", "round to positive infinity", False, ["x"], undefined),
  (Prefix, "round", "Real -> Real", "round to nearest integer", False, ["x"], undefined),
  (Prefix, "truncate", "Real -> Real", "round to zero", False, ["x"], undefined),
  (Prefix, "fract", "Real -> Real", "fractional part", False, ["x"], undefined),
  (Prefix, "mod", "Real -> Real -> Real", "modulus", False, ["x", "y"], undefined),
  (Prefix, "min", "Real -> Real -> Real", "minimum", False, ["x", "y"], undefined),
  (Prefix, "max", "Real -> Real -> Real", "maximum", False, ["x", "y"], undefined),
  (Prefix, "clamp", "Real -> Real -> Real -> Real", "clamp value to given range", True, ["low", "high", "x"], undefined),
  (Prefix, "mix", "Real -> Real -> Real -> Real", "linear interpolation", True, ["a", "x", "y"], undefined),
